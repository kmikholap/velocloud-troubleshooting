...
Velocloud Remote Diagnostics Websocket API - Interface Status
...
async def run_interface_diagnostics(api_client, edges):
    """
    Run Interfaces diagnostics on all edges
    """
...
async def main():
    ...
    # Interfaces Websocket request
    response =  await run_interface_diagnostics(api_client, edges)
