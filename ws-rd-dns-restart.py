...
async def dns_service_restart(api_client, edges):
    """
    Restart DNS service on ALL edges
    """
    ...
    for edge in edges['result']:
        ...
        print(f"Running DNS service restart for edge {logical_id}...")
...
async def main():
    ...
    # DNS Restart Websocket
    response =  await dns_service_restart(api_client, edges)
